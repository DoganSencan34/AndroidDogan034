...
public class EpicDetay extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_epic_detay);
        ...
        Picasso.get().load("https://epic.gsfc.nasa.gov/archive/natural/" + date + "/png/" + img + ".png").into(resim);

       // baslik.setText(getIntent().getExtras().getString("Resim"));
    }
}
